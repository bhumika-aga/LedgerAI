...
| [UI_GUIDELINES.md](./UI_GUIDELINES.md)                                         | **Application across screens** | Defines **how this language is applied** — tone, microcopy, interaction norms, and the conventions for assembling screens. This document defines the vocabulary; UI_GUIDELINES governs its usage in context. Where this document says *what a semantic color means*, UI_GUIDELINES says *how to phrase the message beside it*.                                                                                  |
