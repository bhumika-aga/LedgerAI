...
| Phase 3 — Documents, Storage & OCR  | In Progress | ~35%     | Storage provider resolved ([ADR-002](../01-architecture/decisions/ADR-002-Storage-Provider.md) Accepted → Supabase). Done: Document Management slice — upload/list/get/delete/download, Supabase Storage adapter behind the ADR-008 port, soft-delete, VR-005. OCR still blocked-until OCR provider (DD-002).                                                                                                                                           |
