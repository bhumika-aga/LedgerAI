...
| PD-008 | **Authentication: JWT access + refresh tokens**                                           | Accepted | Stateless, scalable, works cleanly across the Vercel/Render split; standard and well-understood.                       | 2026-07-14 | [ADR-001](../01-architecture/decisions/ADR-001-Authentication-Strategy.md)                                |
